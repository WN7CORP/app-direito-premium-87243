          ...
          {todasFuncionalidades.map((func, index) => {
            ...
            return (
              <button
                ...
                className="bg-gradient-to-br from-[hsl(0,75%,55%)] to-[hsl(350,70%,45%)] rounded-2xl p-5 text-left transition-all hover:scale-105 hover:shadow-2xl min-h-[160px] flex flex-col relative overflow-hidden shadow-xl animate-fade-in"
                style={{
