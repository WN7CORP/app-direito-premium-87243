  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <div className="max-w-5xl mx-auto px-3 py-4">
        ...
        <div className="relative rounded-2xl overflow-hidden p-5 mb-6 shadow-xl">
          <div className={`absolute inset-0 bg-gradient-to-br ${cores.cor} opacity-90`} />
          <div
          ...
          <div className="relative z-10">
            <h1 className="text-2xl md:text-3xl font-bold text-white mb-1 drop-shadow-lg">{area}</h1>
        ...
        <Accordion type="multiple" className="space-y-3">
          {conteudos.videoaulas.length > 0 && (
            <AccordionItem value="videoaulas" className="border-2 rounded-xl px-4 bg-card/50 backdrop-blur-sm overflow-hidden">
              <AccordionTrigger className="hover:no-underline py-4">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-lg bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center shadow-lg shadow-red-500/20">
                  ...
                  <div className="text-left">
                    <h3 className="text-base font-bold">Videoaulas</h3>
                    <p className="text-xs text-muted-foreground">
                      {conteudos.videoaulas.length} videoaulas
                    </p>
                  </div>
                </div>
              </AccordionTrigger>
                ...
                <div className="grid grid-cols-1 gap-2 pt-2 pb-3">
                  {conteudos.videoaulas.map((video: any, index: number) => (
                    <Card
                      ...
                      className="cursor-pointer hover:bg-accent/50 transition-all duration-200 border hover:border-red-500/30 group"
                      ...
                      <CardContent className="p-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="font-semibold text-sm mb-0.5 line-clamp-2">{video.titulo}</h4>
                            <p className="text-xs text-muted-foreground line-clamp-1">
                              {video.categoria} • {video.tempo}
                            </p>
                          </div>
                          <ExternalLink className="w-4 h-4 text-muted-foreground flex-shrink-0 group-hover:text-red-500 transition-colors" />
                        </div>
                      </CardContent>
                    </Card>
                  ))}
          ...
          {conteudos.biblioteca.length > 0 && (
            <AccordionItem value="biblioteca" className="border-2 rounded-xl px-4 bg-card/50 backdrop-blur-sm overflow-hidden">
              <AccordionTrigger className="hover:no-underline py-4">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-lg bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/20">
                    <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <div className="text-left">
                    <h3 className="text-base font-bold">Biblioteca de Estudos</h3>
                    <p className="text-xs text-muted-foreground">
              ...
              <AccordionContent>
                <div className="grid grid-cols-1 gap-2 pt-2 pb-3">
                  {conteudos.biblioteca.map((livro: any) => (
                    <Card
                      key={livro.id}
                      className="cursor-pointer hover:bg-accent/50 transition-all duration-200 border hover:border-blue-500/30 group"
                    ...
                    >
                      <CardContent className="p-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="font-semibold text-sm mb-0.5 line-clamp-2">{livro.Tema}</h4>
                            <p className="text-xs text-muted-foreground">{livro.Área}</p>
                          </div>
                          <ExternalLink className="w-4 h-4 text-muted-foreground flex-shrink-0 group-hover:text-blue-500 transition-colors" />
                        </div>
                      </CardContent>
                    </Card>
                  ))}
          ...
          {conteudos.flashcards.length > 0 && (
            <AccordionItem value="flashcards" className="border-2 rounded-xl px-4 bg-card/50 backdrop-blur-sm overflow-hidden">
              <AccordionTrigger className="hover:no-underline py-4">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-lg bg-gradient-to-br from-yellow-500 to-yellow-600 flex items-center justify-center shadow-lg shadow-yellow-500/20">
                    <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <AccordionContent>
                <div className="grid grid-cols-1 gap-2 pt-2 pb-3">
                  {conteudos.flashcards.map((tema: any) => (
                    <Card
                      key={tema.tema}
                      className="cursor-pointer hover:bg-accent/50 transition-all duration-200 border hover:border-yellow-500/30 group"
                    ...
                    >
                      <CardContent className="p-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="font-semibold text-sm mb-0.5 line-clamp-2">{tema.tema}</h4>
                            <p className="text-xs text-muted-foreground">
                              {tema.total_questoes} {tema.total_questoes === 1 ? "flashcard" : "flashcards"}
                            </p>
                          </div>
                          <ExternalLink className="w-4 h-4 text-muted-foreground flex-shrink-0 group-hover:text-yellow-500 transition-colors" />
                        </div>
                      </CardContent>
                    </Card>
                  ))}
          ...
          {conteudos.mapaMental.length > 0 && (
            <AccordionItem value="mapamental" className="border-2 rounded-xl px-4 bg-card/50 backdrop-blur-sm overflow-hidden">
              <AccordionTrigger className="hover:no-underline py-4">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-lg bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center shadow-lg shadow-purple-500/20">
                    <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <div className="text-left">
                    <h3 className="text-base font-bold">Mapas Mentais</h3>
                    <p className="text-xs text-muted-foreground">
              ...
              <AccordionContent>
                <div className="grid grid-cols-1 gap-2 pt-2 pb-3">
                  {conteudos.mapaMental.map((mapa: any) => (
                    <Card key={mapa.id} className="hover:bg-accent/50 transition-all duration-200 border hover:border-purple-500/30">
                      <CardContent className="p-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="font-semibold text-sm mb-0.5 line-clamp-2">{mapa.tema}</h4>
          ...
          {conteudos.cursos.length > 0 && (
            <AccordionItem value="cursos" className="border-2 rounded-xl px-4 bg-card/50 backdrop-blur-sm overflow-hidden">
              <AccordionTrigger className="hover:no-underline py-4">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-lg bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center shadow-lg shadow-green-500/20">
                    <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <div className="text-left">
                    <h3 className="text-base font-bold">Cursos</h3>
                    <p className="text-xs text-muted-foreground">
              ...
              <AccordionContent>
                <div className="grid grid-cols-1 gap-2 pt-2 pb-3">
                  {conteudos.cursos.map((curso: any) => (
                    <Card
                      key={curso.id}
                      className="cursor-pointer hover:bg-accent/50 transition-all duration-200 border hover:border-green-500/30 group"
                    ...
                    >
                      <CardContent className="p-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="font-semibold text-sm mb-0.5 line-clamp-2">{curso.tema}</h4>
                            <p className="text-xs text-muted-foreground">{curso.area}</p>
                          </div>
                          <ExternalLink className="w-4 h-4 text-muted-foreground flex-shrink-0 group-hover:text-green-500 transition-colors" />
                        </div>
                      </CardContent>
                    </Card>
                  ))}
          ...
          {conteudos.resumos.length > 0 && (
            <AccordionItem value="resumos" className="border-2 rounded-xl px-4 bg-card/50 backdrop-blur-sm overflow-hidden">
              <AccordionTrigger className="hover:no-underline py-4">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-lg bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center shadow-lg shadow-orange-500/20">
                    <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <div className="text-left">
                    <h3 className="text-base font-bold">Resumos Jurídicos</h3>
                    <p className="text-xs text-muted-foreground">
              ...
              <AccordionContent>
                <div className="grid grid-cols-1 gap-2 pt-2 pb-3">
                  {conteudos.resumos.map((resumo: any) => (
                    <Card
                      key={resumo.id}
                      className="cursor-pointer hover:bg-accent/50 transition-all duration-200 border hover:border-orange-500/30 group"
                    ...
                    >
                      <CardContent className="p-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="font-semibold text-sm mb-0.5 line-clamp-2">{resumo.tema}</h4>
                            {resumo.subtema && (
                              <p className="text-xs text-muted-foreground line-clamp-1">{resumo.subtema}</p>
                            )}
                          </div>
                          <ExternalLink className="w-4 h-4 text-muted-foreground flex-shrink-0 group-hover:text-orange-500 transition-colors" />
                        </div>
                      </CardContent>
                    </Card>
                  ))}
        ...
        {totalConteudos === 0 && (
          <div className="text-center py-12">
            <p className="text-muted-foreground text-sm">Nenhum conteúdo encontrado para esta área.</p>
          </div>
        )}
      </div>
    </div>
