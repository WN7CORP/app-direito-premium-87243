...
const CORES_AREAS: Record<string, { cor: string; glowColor: string }> = {
  "Direito Penal": { cor: "bg-red-600", glowColor: "rgb(239, 68, 68)" },
  "Direito Civil": { cor: "bg-blue-600", glowColor: "rgb(59, 130, 246)" },
  "Direito Constitucional": { cor: "bg-green-600", glowColor: "rgb(34, 197, 94)" },
  "Direito Administrativo": { cor: "bg-purple-600", glowColor: "rgb(168, 85, 247)" },
  "Direito Trabalhista": { cor: "bg-yellow-600", glowColor: "rgb(234, 179, 8)" },
  "Direito Empresarial": { cor: "bg-pink-600", glowColor: "rgb(236, 72, 153)" },
  "Direito Tributário": { cor: "bg-indigo-600", glowColor: "rgb(99, 102, 241)" },
  "Direito Processual Civil": { cor: "bg-cyan-600", glowColor: "rgb(6, 182, 212)" },
  "Direito Processual Penal": { cor: "bg-orange-600", glowColor: "rgb(249, 115, 22)" }
};
  ...
  const fetchTemas = async () => {
    try {
      const { data, error } = await supabase
        ...
        .select('id, tema, link, sequencia, area')
        .eq('area', areaDecoded)
      ...
      <div className="bg-card border-b border-border sticky top-0 z-10">
        <div className="max-w-[600px] lg:max-w-4xl mx-auto px-4 py-4">
          ...
          <div className="flex items-center gap-3">
            <div 
              className={`w-3 h-12 rounded ${areaConfig.cor} shadow-lg`}
              style={{
        ...
        <div className="relative space-y-6">
          ...
          {temas.map((temaData, index) => (
            ...
            >
              {/* Marcador colorido */}
              <div 
                className={`absolute left-0 top-4 w-7 h-7 rounded-full ${areaConfig.cor} border-4 border-background flex items-center justify-center shadow-xl`}
                style={{
              ...
              {/* Card do tema */}
              <div 
                className="w-full backdrop-blur-sm border-2 border-border/50 rounded-lg shadow-xl transition-all duration-300 hover:shadow-2xl overflow-hidden"
                style={{
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      onClick={() => handleDownloadClick(temaData.link)}
                      variant="outline"
                      size="sm"
                      className="flex-1"
                    >
