...
const CrimesHediondosView = () => {
  ...
  const { data: articles = [], isLoading } = useQuery({
    queryKey: ['crimes-hediondos-articles-v3'],
    queryFn: async () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-24">
      ...
      <ExplicacaoModal isOpen={modalOpen} onClose={() => setModalOpen(false)} artigo={modalData.artigo} numeroArtigo={modalData.numeroArtigo} tipo={modalData.tipo} nivel={modalData.nivel} codigo="ch" codigoTabela={tableName} />
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 animate-fade-in">
        <ArtigoActionsMenu
          article={article}
          codigoNome="Lei de Crimes Hediondos"
