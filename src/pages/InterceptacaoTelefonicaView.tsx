...
const InterceptacaoTelefonicaView = () => {
  ...
  const { data: articles = [], isLoading } = useQuery({
    queryKey: ['interceptacao-telefonica-articles-v3'],
    queryFn: async () => {
            ...
            {isLoading ? (
              ...
              <ArtigoListaCompacta
                ...
                onArtigoClick={(article) => {
                  setViewMode('expandido');
                  setSearchQuery(article["Número do Artigo"] || "");
                }}
                ...
                onOpenExplicacao={(artigo, numeroArtigo, tipo, nivel) => {
                  setModalData({ artigo, numeroArtigo, tipo: tipo, nivel: nivel || "tecnico" });
                  setModalOpen(true);
                }}
                onGenerateFlashcards={(artigo, numeroArtigo) => handleGenerateFlashcards(artigo, numeroArtigo)}
