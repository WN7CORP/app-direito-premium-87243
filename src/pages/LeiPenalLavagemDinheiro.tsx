...
const ArticleCard = ({
  ...
  return (
    <div 
      ...
      className="bg-card rounded-2xl p-6 border transition-all border-border/50 hover:border-[hsl(45,93%,58%)]/30 hover:shadow-[hsl(45,93%,58%)]/5 animate-fade-in"
      style={{
      ...
      <div className="space-y-3">
        ...
        {article["Comentario"] && (
          <div className="mt-4 pt-4 border-t border-border/50">
            <AudioCommentButton 
              isPlaying={false}
              onClick={() => onPlayComment(article["Comentario"] || "", `Comentário - Art. ${article["Número do Artigo"] || ""}` )}
            />
          </div>
        )}
